...
void stop(const std::string name) {
    ...
    throw error("invalid log output name in stop");
}
...
void set_level(const std::string name, log::level level) {
    ...
    throw error("invalid log output name in set level");
}
...
void set_level_stamp(const std::string name, bool level) {
    ...
    throw error("invalid log output name in set level stamp");
}
...
void set_datetime_stamp(const std::string name, bool datetime) {
    ...
    throw error("invalid log output name in set datetime stamp");
}
...
void set_line_numbers(const std::string name, bool line_numbers) {
    ...
    throw error("invalid log output name in set line numbers");
}
